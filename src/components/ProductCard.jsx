...
function ProductCard({ product, compact = false }) {
  ...
  return (
    <div className={`bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group ${compact ? "flex gap-3" : "flex flex-col h-full"}`}>
      {/* Product Image */}
      ...
      {/* Product Info */}
      <div className={compact ? "py-1 pr-2 flex-1 min-w-0" : "p-4 flex flex-col flex-1"}>
